...
const FIELD_SEED: Record<string, [number, number]> = {
	// Mind & Behavior — DO fields (right quadrant)
	psychology:                    [ 1.0,   0.15],
	cognitive_science:             [ 0.72, -0.25],
	neuroscience:                  [ 0.85,  0.55],
	behavioral_economics:          [ 0.62,  0.40],  // mind↔formal bridge
	naturalistic_decision_making:  [ 0.55, -0.10],  // mind↔societal bridge
	marketing:                     [ 1.05,  0.42],

	// Formal & Computational — SHOULD+COULD fields (bottom-right + top-right)
	economics:                     [ 0.2,   0.88],
	statistics:                    [ 0.7,   1.0 ],
	decision_theory:               [ 0.45,  0.70],
	game_theory:                   [ 0.05,  1.05],
	operations_research:           [ 0.05,  1.0 ],
	artificial_intelligence:       [ 0.62, -0.72],
	computer_science:              [ 0.9,  -0.5 ],
	multi_criteria_decision_making:[-0.1,   1.05],
	decision_support_systems:      [ 0.1,  -0.55],
	recommender_systems:           [ 0.55, -0.85],
	data_driven_decision_making:   [ 0.4,  -0.55],

	// Design & Interaction — COULD fields (top-left)
	information_visualization:     [-0.15, -1.05],
	hci:                           [-0.62, -0.82],

	// Collective & Societal — DO fields (left quadrant)
	management_science:            [-0.7,   0.45],
	sociology:                     [-0.92,  0.75],
	anthropology:                  [-0.72,  0.95],
	political_science:             [-1.0,   0.2 ],

	// Philosophy — SHOULD field (upper-left, standalone)
